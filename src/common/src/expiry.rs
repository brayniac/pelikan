...
impl Expiry {
    ...
    pub fn as_duration(&self) -> crate::time::precise::Duration {
        crate::time::precise::Duration::from_secs(self.as_secs())
    }

    pub fn as_coarse_duration(&self) -> crate::time::coarse::Duration {
        crate::time::coarse::Duration::from_secs(self.as_secs())
    }
}
